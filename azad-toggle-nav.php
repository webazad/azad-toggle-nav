...
if(! class_exists('Azad_Toggle_Nav')){
    final class Azad_Toggle_Nav{
        ...
        public function azad_public_scripts(){
			...
			///wp_register_script( 'azad-jquery', plugins_url( 'azad-jquery.min.js', __FILE__ ), array(), '23', true );
			wp_register_script( 'azad-modernizr', plugins_url( 'modernizr.min.js', __FILE__ ), array(), '23', false );
            wp_register_script( 'azad-slicknav', plugins_url( 'jquery.slicknav.js', __FILE__ ), array('azad-jquery'), '23', true );
            wp_register_script( 'azad-activation', plugins_url( 'activation.js', __FILE__ ), array('azad-jquery','azad-slicknav'), '23', true );
            
            wp_enqueue_script('azad-modernizr');
            wp_enqueue_script('azad-slicknav');
            wp_enqueue_script('azad-activation');
        }
